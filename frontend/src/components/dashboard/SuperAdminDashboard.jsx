...
import { Users, User, Briefcase, FileText, DollarSign } from 'lucide-react';
    ...
    return (
        <div className="space-y-8">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <StatCard icon={<FileText />} title="Total Grants" value={stats.totalGrants} color="yellow" />
                <StatCard icon={<FileText />} title="Total Applications" value={stats.totalApplications} color="pink" />
